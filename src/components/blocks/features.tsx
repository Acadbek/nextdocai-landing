                ...
                <div key={i} className="flex flex-1 max-md:flex-col">
                  <div className="flex-1 p-3">
                    ...
                    >
                      ...
                      <div className="rounded-full border p-2 transition-colors opacity-50 group-hover:opacity-100 group-hover:bg-brand/30" style={{ borderColor: "var(--brand)", backgroundColor: "color-mix(in oklch, var(--brand) 12%, transparent)" }}>
                        <ChevronRight className="size-5 text-brand lg:size-6" />
                      </div>
                    </Link>
                  </div>
                  {i < topItems.length - 1 && (
